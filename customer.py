...
class Cust_Win:
    def __init__(self, root):
        ...
        # ====================TITLE====================
        lbl_title = Label(self.root, text="ADD CUSTOMER DETAILS", font=("Dutch801 XBd BT",30,"bold"), bg="black", fg="gold")
        ...
        entry_ref=ttk.Entry(labelframeleft,textvariable=self.var_ref,width=28,font=("arial",12,"bold"),state="readonly")
        ...
        combo_id["value"]=("AadharCard","PanCard","Driving Licence")
        combo_id.current(0)
        ...
        txtIdNumber=ttk.Entry(labelframeleft,textvariable=self.var_id_number,width=29,font=("arial",12,"bold"))
        ...
        Table_Frame.place(x=440,y=50,width=830,height=490)
